...
import { ToastalertComponent } from './alerts/toastalert/toastalert.component';
...
export const routes: Routes = [
    ...
    {path: 'login', component: LoginComponent, data: {title: 'IFS | Login'}},
    ...
    {path: 'toastalert', component: ToastalertComponent},
